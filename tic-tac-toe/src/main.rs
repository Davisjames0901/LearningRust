...
impl fmt::Display for GameState {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        writeln!(f, "7 | 8 | 9    {} | {} | {}", self.board[6], self.board[7], self.board[8]);
        writeln!(f, "---------    ---------");
        writeln!(f, "4 | 5 | 6    {} | {} | {}", self.board[3], self.board[4], self.board[5]);
        writeln!(f, "---------    ---------");
        writeln!(f, "1 | 2 | 3    {} | {} | {}", self.board[0], self.board[1], self.board[2]);
        writeln!(f, "\n {} Make your move!", self.current_player)
    }
}